...
AI_SERVICE_ENABLED = _as_bool(_env_or_db("AI_SERVICE_ENABLED", "true"), default=True)
AI_SERVICE_URL = _env_or_db("AI_SERVICE_URL", "http://localhost:8100")
AI_SERVICE_TIMEOUT_SECONDS = _as_float(_env_or_db("AI_SERVICE_TIMEOUT_SECONDS", "20"), 20.0)
AI_SERVICE_AUTH_TOKEN = _env_or_db("AI_SERVICE_AUTH_TOKEN", "")
