...
SENDGRID_INBOUND_WEBHOOK_TOKEN = os.getenv("SENDGRID_INBOUND_WEBHOOK_TOKEN", "")
...
COLD_LEAD_THRESHOLD_DAYS = int(os.getenv("COLD_LEAD_THRESHOLD_DAYS", "10"))
SCHEDULER_FOLLOWUP_BATCH_SIZE = int(os.getenv("SCHEDULER_FOLLOWUP_BATCH_SIZE", "100"))

SLACK_ENABLED = os.getenv("SLACK_ENABLED", "false").strip().lower() in {"1", "true", "yes", "on"}
